// ----------------------------------------------------------------------------------------------------------------
// -- Final02Scene.js: poucos robôs destruídos
// ----------------------------------------------------------------------------------------------------------------

// ----------------------------------------------------------------------------------------------------------------

export class Final02Scene extends Phaser.Scene {

    constructor(config) {
        // Define a chave da cena
        super({ key: 'Final02Scene' });
    ...
    createBackground() {
        ...
        this.typeText(
            'A missão foi concluída com o\n' +
            'mínimo de destruição possível.\n\n' +
            '--------------------------------------------\n' +
            'Cooperação entre humanos e sistemas\n' +
            'autônomos ainda é possível.\n' +
            '--------------------------------------------\n\n' +
            'AISTORM encerra seus protocolos autoritários\n' +
            'e libera o controle da rede.'
        , 40);
